...
__all__ = [
    ...
    "planning_summary", "classify_zone", "required_adjacencies",
    "adjacency_proximity_score", "overlap_penalty", "zoning_score",
    "grid_alignment_score", "constraint_report", "BuildingModel",
    "generate_building", "building_summary", "check_project", "score_project",
]
